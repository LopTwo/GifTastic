$(document).ready(function () {
	var movies = ["Interstellar", "The Hurt Locker", "Scott Pilgrim vs. the World", "Ferris Bueller's Day Off", "Shrek", "Black Hawk Down", "Donnie Darko", "A Night at the Roxbury"];
	...
	$("button").on("click", function () {
		...
		var queryURL = "https://api.giphy.com/v1/gifs/search?q=" +
			movie + "&api_key=FvLFWh6ir0qrraHnfDnaXtLIPl6eMBN9"
